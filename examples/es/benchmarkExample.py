...
STRATEGIES = ["oneplusone", "miplusone", "mipluslambda"]
...
def main():
    ...
    parser.add_argument("--lambda", dest="l", required=False, type=int,
    ...
    elif args.strategy == "mipluslambda":
        result = e.miPlusLambdaES(benchmark, args.dimension, args.mi, args.l, args.iterations)
    else:
